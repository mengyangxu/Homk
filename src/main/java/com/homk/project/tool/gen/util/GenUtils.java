package com.homk.project.tool.gen.util;

import com.homk.common.constant.CommonMap;
...
{
    /** 项目空间路径 */
    private static final String PROJECT_PATH = "main/java/com/homk/project";
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getModuleName("com.homk.project.system"));
    }
}
